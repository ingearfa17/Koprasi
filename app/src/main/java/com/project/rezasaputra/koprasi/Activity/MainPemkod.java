...
public class MainPemkod extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_pemkod);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_pemkod, menu);
        return true;
    }
    ...
    public void logoutUser() {
        ...
        Intent intent = new Intent(MainPemkod.this, Login.class);
